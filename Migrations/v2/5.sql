...
-- REMOVED b/c already did these manually
-- drop table MasterVersion;
-- drop table ShortLocks;
...
begin 
   ...
   START TRANSACTION;
		...
		ALTER TABLE FileIndex DROP COLUMN appMetaDataVersion;
		ALTER TABLE Upload DROP COLUMN appMetaDataVersion;
